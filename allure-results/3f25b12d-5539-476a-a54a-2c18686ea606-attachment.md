...
Locator: locator('h1.hero__title heroTitle_ohkl')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('h1.hero__title heroTitle_ohkl')
        ...
        - generic [ref=e43]:
          ...
          - generic [ref=e45]:
            - link "Star microsoft/playwright on GitHub" [ref=e46] [cursor=pointer]:
              - /url: https://github.com/microsoft/playwright
              - text: Star
            - link "94k+ stargazers on GitHub" [ref=e48] [cursor=pointer]:
...
```ts
  ...
  10 |         this.page = page;
  11 |         this.getStartedButton = page.locator('text=Get Started');
  12 |         this.homePageHeader = page.locator('h1.hero__title heroTitle_ohkl');
  13 |         this.installationHeader = page.locator('h1.Installation');
  14 |     }
  15 | 
  16 |     async navigateToHomePage() {
  17 |         await this.page.goto('https://playwright.dev/');
  18 |     }
  19 | 
