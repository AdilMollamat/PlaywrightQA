...
```
Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'What\'s installed' }) resolved to 3 elements:
    1) <a class="" href="/docs/intro#whats-installed">What's installed</a> aka getByRole('link', { name: 'What\'s installed', exact: true })
    2) <a translate="no" class="hash-link" href="#whats-installed" title="Direct link to What's Installed" aria-label="Direct link to What's Installed">​</a> aka getByRole('link', { name: 'Direct link to What\'s Installed' })
    3) <a href="#whats-installed" class="table-of-contents__link toc-highlight">What's Installed</a> aka getByRole('link', { name: 'What\'s Installed', exact: true })

Call log:
  - waiting for getByRole('link', { name: 'What\'s installed' })
        ...
        - list [ref=e41]:
          ...
          - listitem [ref=e133]:
            ...
            - list [ref=e137]:
              ...
              - listitem [ref=e171]:
                - link "Component testing" [ref=e172] [cursor=pointer]:
                  - /url: /docs/test-components
                  - generic "Component testing" [ref=e173]
              - listitem [ref=e174]:
        ...
        - generic [ref=e267]:
          - article [ref=e268]:
            ...
            - generic [ref=e279]:
              ...
              - list [ref=e287]:
                - listitem [ref=e288]:
                  - link "How to install Playwright" [active] [ref=e289] [cursor=pointer]:
...
```ts
  ...
  2  | 
  3  | export class StartedPage {
  4  |     readonly page: Page;
  5  |     readonly installationHeader: Locator;
  6  |     readonly getStartedLink: Locator;
  7  |     readonly howToInstallLink: Locator;
  8  |     readonly whatIsPlaywrightLink: Locator;
  9  |     readonly runTestsLink: Locator;
  10 |     readonly openReportLink: Locator;
  11 | 
  12 |     constructor(page: Page) {
  13 |         this.page = page;
  14 |         this.installationHeader = page.getByRole('heading', { name: 'Installation' });
  15 |         this.getStartedLink = page.getByRole('link', { name: 'Get Started' });
  16 |         this.howToInstallLink = page.getByRole('link', { name: 'How to install Playwright' });
  17 |         this.whatIsPlaywrightLink = page.getByRole('link', { name: 'What\'s installed' });
  18 |         this.runTestsLink = page.getByRole('link', { name: 'How to run the example test' });
  19 |         this.openReportLink = page.getByRole('link', { name: 'How to open the HTML test report' });
  20 |     }
  21 | 
  22 |     async validateInstallationHeader() {
  23 |         await expect(this.installationHeader).toBeVisible();
  24 |     }
  25 | 
  26 |     async clickGetStartedButton() {
  27 |         await this.getStartedLink.click();
  28 |     }
  29 | 
  30 |     async clickHowToInstallLink() {
  31 |         await this.howToInstallLink.click();
  32 |     }
  33 | 
  34 |     async clickAllLinks() {
  35 |         await this.howToInstallLink.click();
> 36 |         await this.whatIsPlaywrightLink.click();
     |                                         ^ Error: locator.click: Error: strict mode violation: getByRole('link', { name: 'What\'s installed' }) resolved to 3 elements:
  37 |         await this.runTestsLink.click();
  38 |         await this.openReportLink.click();
  39 |     }
  40 | }
```